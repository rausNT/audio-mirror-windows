...
internal static class Program
{
    ...
    private const string DisplayVersion = "0.9.25";
    private const string RepositoryUrl = "https://github.com/rausNT/audio-mirror-windows";
    private const string ReleaseSummary =
        "Changes in this update:\n" +
        "- Reworks the main window into a left-navigation layout with a larger default workspace.\n" +
        "- Automatically unmutes selected target devices at start if Windows leaves them muted or at 0%.\n" +
        "- Keeps Source mute under Windows keyboard control while mirroring.\n" +
        ...
        "- Documents the setup wizard flow in README.\n" +
