...
internal static class AppText
{
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Hint"] = "Set Windows default output to the selected Source, restart the player if captured frames stay at 0.",
        ["Close"] = "Close",
        ["Left"] = "Left",
        ["Right"] = "Right",
        ["Both"] = "Both",
