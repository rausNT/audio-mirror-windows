...
internal static class AppText
{
    ...
    private static readonly Dictionary<string, string> English = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["StatusNoSourceAudio"] = "No source audio",
    ...
    static AppText()
    {
        Add("ru",
            ...
            ("NoAudioReachingSource", "Звук не поступает на Source. Сделайте Source устройством вывода Windows по умолчанию, затем перезапустите браузер или плеер."),
